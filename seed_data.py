...
• Exceptional copywriting and analytical skills""",
            ...
            JobRequisition(
                ...
                job_description="""Draft requisition for upcoming candidate matching feature.""",
                status="Draft",
    ...
    sample_resume_path = os.path.join(UPLOAD_DIR, "Priya_Sharma_Resume.pdf")
    ...
    if backend_req and db.query(Application).count() == 0:
        ...
        for name, email, loc, exp_yrs, status_val, r_name in sample_candidates_data:
            ...
            r_path = os.path.join(UPLOAD_DIR, r_name)
            ...
            app_rec = Application(
                ...
                candidate_id=u.id,
                cover_note=f"Experienced software engineer excited about joining TalentBridge.",
            ...
            exp = WorkExperienceRecord(
                ...
                key_responsibilities="Engineered microservices and optimized database queries.",
